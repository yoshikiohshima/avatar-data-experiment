...
class Shell {
    constructor() {
        ...
        _croquet_croquet__WEBPACK_IMPORTED_MODULE_0__.App.autoSession();
        _croquet_croquet__WEBPACK_IMPORTED_MODULE_0__.App.autoPassword();
        const primaryId = this.primaryFrameId = this.addFrame(null, _croquet_croquet__WEBPACK_IMPORTED_MODULE_0__.App.sessionURL);
