            ...
            switch (command) {
                case "frame-type":
                   ...
                   if (spec) {
                       ...
                       if (spec.frameTypeChange) this.frameTypeChanged(isPrimary, spec);
                   }
...
class CardPawn extends (0,_worldcore__WEBPACK_IMPORTED_MODULE_0__.mix)(_worldcore__WEBPACK_IMPORTED_MODULE_0__.Pawn).with(_worldcore__WEBPACK_IMPORTED_MODULE_0__.PM_Smoothed, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.PM_ThreeVisible, _Pointer_js__WEBPACK_IMPORTED_MODULE_2__.PM_PointerTarget, _code_js__WEBPACK_IMPORTED_MODULE_6__.PM_Code) {
    ...
    roundedCornerGeometry(width, height, depth, cornerRadius) {
        ...
        let geometry;
        if (depth > 0) {
            geometry = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.ExtrudeGeometry(shape, {extrudePath});
        } else {
            geometry = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.ShapeGeometry(shape);
        }
        ...
        if (depth > 0) {
            newGeometry = (0,_assetManager_js__WEBPACK_IMPORTED_MODULE_3__.toIndexed)(geometry, _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE, true);
        }
    ...
    makePlaneMaterial(depth, color, frameColor, fullBright, singleSided) {
        ...
        let material;
        let side = singleSided === undefined || singleSided ? _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.FrontSide : _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.DoubleSide;
        if (!fullBright) {
            material = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.MeshPhongMaterial({color:color, side});
        } else {
            material = new _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.THREE.MeshBasicMaterial({color:color, side, toneMapped: false});
        }
